...
static GRASS_TEXTURE: Lazy<Texture2D> = Lazy::new(|| {
    load_texture_sync("assets/textures/tiles/grass.png").expect("Failed to load grass texture")
});
...
impl Tile for GrassTile {
    fn get_type_tag(&self) -> &'static str { "grass" }
